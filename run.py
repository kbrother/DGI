...
def pre_train(args):    
    ...
    for epoch in range(args.epochs):
        ...
        if loss < best:
            ...
            best_t = epoch
            cnt_wait = 0
            torch.save(model.state_dict(), 'output/best_dgi.pkl')
        else:
            cnt_wait += 1
...
if __name__ == "__main__":
    ...
    parser.add_argument('--l2-coef', '-l2', type=float, 
                        default= 0.0, help='L2 coefficient')
    parser.add_argument('--drop-prob', '-dp', type=float, 
